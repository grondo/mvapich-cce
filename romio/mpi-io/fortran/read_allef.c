...
/* 
 *   $Id: read_allef.c,v 1.13 2003/07/08 22:25:46 thakur Exp $    
 *
...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_ALL_END( MPI_Fint *, void*, MPI_Status*, MPI_Fint * );
#pragma weak MPI_FILE_READ_ALL_END = PMPI_FILE_READ_ALL_END
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_all_end__( MPI_Fint *, void*, MPI_Status*, MPI_Fint * );
#pragma weak mpi_file_read_all_end__ = pmpi_file_read_all_end__
#elif !defined(FORTRANUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_all_end( MPI_Fint *, void*, MPI_Status*, MPI_Fint * );
#pragma weak mpi_file_read_all_end = pmpi_file_read_all_end
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_all_end_( MPI_Fint *, void*, MPI_Status*, MPI_Fint * );

...
#define MPIRUN_USE_TREES (0)
#endif
#ifndef MPIRUN_USE_GATHER_TREE
#define MPIRUN_USE_GATHER_TREE (0)
#endif
#ifndef MPIRUN_USE_BCAST_TREE
#define MPIRUN_USE_BCAST_TREE (0)
#endif
...
int   pmgr_nprocs = -1;
int   pmgr_id     = -1;
static int pmgr_close_on_abort = 0;

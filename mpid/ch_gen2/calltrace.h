...
/* This includes the definitions found by configure, 
 * and can be found in the library directory (lib/$ARCH/$COMM) 
...
#define TR_PUSH(a) {                                                \
    ...
    if (TR_stack_sp < TR_MAX_STACK) {                               \
        TR_stack[TR_stack_sp++] = a;                                \
    }                                                               \
}

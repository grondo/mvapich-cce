...
extern void init_apm_lock();
extern int viadev_init_async_progress();
extern int reload_alternate_path(struct ibv_qp *);
extern void viadev_finalize_async_progress();
extern int perform_manual_apm(struct ibv_qp*);

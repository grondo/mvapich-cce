...
public class ClogToSlog2
{
    ...
    {
        logformat.clogTOdrawable.InputLog   dobj_ins;
        ...
        /* */    Date time1 = new Date();
        dobj_ins   = new logformat.clogTOdrawable.InputLog( in_filename );
    ...
    private static String help_msg = "Usage: java slog2.output.Clog2Slog "
                                   + "[options] clog_filename.\n"
                                   + " options: \n"
                                   + "\t [-h|--h|-help|--help]             "
    ...
    private static void parseCmdLineArgs( String argv[] )
    {
        ...
        if ( in_filename == null ) {
            System.err.println( "The Program needs a CLOG filename as "
